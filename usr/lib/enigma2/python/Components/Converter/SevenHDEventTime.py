...
class SevenHDEventTime(Poll, Converter, object):
	STARTTIME = 0
	ENDTIME = 1
	REMAINING = 2
	REMAINING_VFD = 3
	...
	def __init__(self, type):
		...
		if type == "EndTime":
			...
			raise ElementError("'%s' is not <StartTime|EndTime|Remaining|Elapsed|Duration|Progress|Runtime> for EventTime converter" % type)
